 ...
 *
 * C source code generated on: Tue Oct 11 15:46:35 2011
 *
 */
...
static void m_b_filter(real_T eml_b[5], real_T eml_a[5], real_T
...
static void m_b_max(real_T eml_varargin_1_data[6912], int32_T
 ...
 eml_maxval_sizes[2]);
static void m_b_power(real_T eml_b_data[6912], int32_T eml_b_sizes[2], real_T
 eml_y_data[6912], int32_T eml_y_sizes[2]);
static void m_c_eml_scalexp_alloc(real_T eml_varargin_2_data[6912], int32_T
 eml_varargin_2_sizes[2], real_T eml_z_data[6912], int32_T eml_z_sizes[2]);
static void m_c_filter(real_T eml_b[2], real_T eml_a[2], real_T
 eml_x_data[6912], int32_T eml_x_sizes[2], real_T eml_zi, real_T
 eml_y_data[6912], int32_T eml_y_sizes[2], real_T *eml_zf);
static void m_c_power(real_T eml_a_data[6912], int32_T eml_a_sizes[2], real_T
 eml_y_data[6912], int32_T eml_y_sizes[2]);
static int32_T m_compute_nones(boolean_T eml_x_data[6912], int32_T
 eml_x_sizes[2], int32_T eml_n);
static void m_d_eml_scalexp_alloc(real_T eml_varargin_1_data[6912], int32_T
 eml_varargin_1_sizes[2], real_T eml_z_data[6912], int32_T eml_z_sizes[2]);
...
static void m_eml_scalexp_alloc(real_T eml_varargin_1_data[6912], int32_T
 eml_varargin_1_sizes[2], real_T eml_z_data[6912], int32_T eml_z_sizes[2]);
static void m_filter(real_T eml_b[2], real_T eml_a[3], real_T eml_x_data[6912],
 int32_T eml_x_sizes[2], real_T eml_zi_data[190], int32_T eml_zi_sizes[1],
 real_T eml_y_data[6912], int32_T eml_y_sizes[2], real_T eml_zf[2]);
 ...
 eml_y_data[6912], int32_T eml_y_sizes[2])
{
  ...
  for(eml_loop_ub = 0; eml_loop_ub < 2; eml_loop_ub++) {
    eml_iv4[eml_loop_ub] = (int16_T)eml_x_sizes[eml_loop_ub];
  }
  eml_iv5[0] = 1;
  eml_iv5[1] = eml_iv4[1];
  eml_tmp_sizes[0] = 1;
  eml_tmp_sizes[1] = eml_iv5[1];
  for(eml_loop_ub = 0; eml_loop_ub < 2; eml_loop_ub++) {
 ...
 eml_maxval_sizes[2])
{
  int32_T eml_loop_ub;
  int32_T eml_k;
  m_b_eml_scalexp_alloc(eml_varargin_1_data, eml_varargin_1_sizes,
 ...
 int32_T eml_z_sizes[2])
{
  ...
  if(!(eml_varargin_2_sizes[1] == 1)) {
    for(eml_i2 = 0; eml_i2 < 2; eml_i2++) {
      eml_iv14[eml_i2] = (int16_T)eml_varargin_2_sizes[eml_i2];
    }
    eml_iv15[0] = 1;
    eml_iv15[1] = eml_iv14[1];
    eml_tmp_sizes[0] = 1;
    eml_tmp_sizes[1] = eml_iv15[1];
    for(eml_i2 = 0; eml_i2 < 2; eml_i2++) {
 ...
 eml_y_data[6912], int32_T eml_y_sizes[2], real_T *eml_zf)
{
  ...
  for(eml_k = 0; eml_k < 2; eml_k++) {
    eml_iv10[eml_k] = (int16_T)eml_x_sizes[eml_k];
  }
  eml_iv11[0] = 1;
  eml_iv11[1] = eml_iv10[1];
  eml_tmp_sizes[0] = 1;
 ...
 int32_T eml_z_sizes[2])
{
  ...
  if(!(eml_varargin_1_sizes[1] == 1)) {
    for(eml_i3 = 0; eml_i3 < 2; eml_i3++) {
      eml_iv16[eml_i3] = (int16_T)eml_varargin_1_sizes[eml_i3];
    }
    eml_iv17[0] = 1;
    eml_iv17[1] = eml_iv16[1];
    eml_tmp_sizes[0] = 1;
    eml_tmp_sizes[1] = eml_iv17[1];
    for(eml_i3 = 0; eml_i3 < 2; eml_i3++) {
 ...
 int32_T eml_y_data[6912], int32_T eml_y_sizes[2])
{
  ...
  eml_n = eml_x_sizes[1];
  eml_iv18[0] = 1;
  eml_iv18[1] = m_compute_nones(eml_x_data, eml_x_sizes, eml_n);
  eml_tmp_sizes[0] = 1;
 ...
 eml_z_sizes[2])
{
  ...
  if(!(eml_varargin_1_sizes[1] == 1)) {
    for(eml_i0 = 0; eml_i0 < 2; eml_i0++) {
      eml_iv7[eml_i0] = (int16_T)eml_varargin_1_sizes[eml_i0];
    }
    eml_iv8[0] = 1;
    eml_iv8[1] = eml_iv7[1];
    eml_tmp_sizes[0] = 1;
...
static void m_filter(real_T eml_b[2], real_T eml_a[3], real_T eml_x_data[6912],
 int32_T eml_x_sizes[2], real_T eml_zi_data[190],
 int32_T eml_zi_sizes[1], real_T eml_y_data[6912], int32_T eml_y_sizes[2],
 real_T eml_zf[2])
{
  real_T eml_a1;
  ...
  for(eml_k = 0; eml_k < 2; eml_k++) {
    eml_iv0[eml_k] = (int16_T)eml_x_sizes[eml_k];
  }
  eml_iv1[0] = 1;
  eml_iv1[1] = eml_iv0[1];
  eml_tmp_sizes[0] = 1;
 ...
 eml_i_data[6912], int32_T eml_i_sizes[2])
{
  ...
  if(eml_nx == 1) {
    ...
    eml_b_tmp_sizes[0] = 1;
    eml_iv6[0] = 1;
    eml_iv6[1] = eml_hoistedExpr_sizes[0];
    eml_b_tmp_sizes[1] = eml_iv6[1];
    eml_ii = eml_hoistedExpr_sizes[0] - 1;
    for(eml_nx = 0; eml_nx <= eml_ii; eml_nx++) {
      eml_tmp_data[eml_nx] = eml_hoistedExpr_data[eml_nx];
    }
    eml_iv6[0] = 1;
    eml_iv6[1] = eml_b_tmp_sizes[1];
    eml_b_i_sizes[0] = 1;
    eml_b_i_sizes[1] = eml_iv6[1];
    eml_nx = eml_iv6[1] - 1;
 ...
 eml_x_sizes[2], real_T eml_b, real_T eml_c)
{
  ...
  m_power(eml_c_abs_x_data, eml_c_abs_x_sizes, eml_c, eml_abs_x_data,
   eml_abs_x_sizes);
  eml_b_abs_x_sizes[0] = 1;
  eml_b_abs_x_sizes[1] = eml_idx_sizes[1];
 ...
 real_T eml_mainGain[11], boolean_T eml_useGTF)
{
  ...
  real_T eml_ab_hoistedExpr_data[3000];
  int32_T eml_h_tmp_sizes[2];
  real_T eml_g_tmp_data[3000];
  ...
  static real_T eml_d_filterStatesR_data[3000];
  ...
  int32_T eml_lb_hoistedExpr_sizes[1];
  static real_T eml_gb_hoistedExpr_data[6912];
  int32_T eml_mb_hoistedExpr_sizes[2];
  ...
  boolean_T eml_c_yR_data[6912];
  static int32_T eml_i_tmp_data[6912];
  ...
  eml_b_hoistedExpr_sizes[0] = 1;
  eml_b_frameBufferL_sizes[0] = 1;
  eml_b_frameBufferL_sizes[1] = eml_g_hoistedExpr_sizes[0];
  eml_b_hoistedExpr_sizes[1] = eml_b_frameBufferL_sizes[1];
  ...
  for(eml_filterCount = 1; (real_T)eml_filterCount <= eml_numChannels;
   eml_filterCount++) {
    ...
    for(eml_y = 0; eml_y <= eml_b_loop_ub; eml_y++) {
      eml_b_yR_data[eml_y] = eml_MOCcontrol[eml_loop_ub + 11 *
    ...
    if(eml_useGTF) {
      for(eml_c_loop_ub = 1.0; eml_c_loop_ub <= eml_filterOrder;
       eml_c_loop_ub++) {
        ...
        eml_k_hoistedExpr_sizes[0] = ((int32_T)eml_d0 -
          (int32_T)eml_b_MOCthreshold_dBOP) + 1;
        eml_loop_ub = (int32_T)eml_d0 - (int32_T)eml_b_MOCthreshold_dBOP;
        for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
          eml_h_hoistedExpr_data[eml_b_loop_ub] = eml_b_MOCthreshold_dBOP +
            (real_T)eml_b_loop_ub;
        }
        eml_b_tmp_sizes[0] = 1;
        eml_b_frameBufferL_sizes[0] = 1;
        eml_b_frameBufferL_sizes[1] = eml_k_hoistedExpr_sizes[0];
        eml_b_tmp_sizes[1] = eml_b_frameBufferL_sizes[1];
        eml_loop_ub = eml_k_hoistedExpr_sizes[0] - 1;
        for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
          eml_tmp_data[eml_b_loop_ub] = eml_h_hoistedExpr_data[eml_b_loop_ub];
        }
        ...
        for(eml_loop_ub = 0; eml_loop_ub < 3; eml_loop_ub++) {
          eml_c_filterCoeffs[eml_loop_ub] = eml_filterCoeffs[(eml_y + (14 +
            eml_loop_ub)) - 1];
        }
        eml_b_frameBufferL_sizes[0] = 1;
        eml_b_frameBufferL_sizes[1] = eml_b_tmp_sizes[1];
        eml_l_hoistedExpr_sizes[0] = 1;
        eml_l_hoistedExpr_sizes[1] = eml_b_frameBufferL_sizes[1];
        eml_loop_ub = eml_b_frameBufferL_sizes[1] - 1;
        for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
          for(eml_y = 0; eml_y <= 0; eml_y = 1) {
            eml_i_hoistedExpr_data[eml_b_loop_ub] =
              eml_filterStatesL[(int32_T)eml_tmp_data[eml_b_loop_ub] - 1];
          }
        }
        ...
        m_filter(eml_b_filterCoeffs, eml_c_filterCoeffs, eml_b_yL_data,
         eml_b_yL_sizes, eml_filterStatesL_data,
         eml_filterStatesL_sizes, eml_c_yL_data, eml_yL_sizes,
         eml_d_filterCoeffs);
        eml_b_MOCthreshold_dBOP = ((real_T)(17 * (eml_filterCount - 1)) + 3.0) +
          (eml_c_loop_ub - 1.0) * 2.0;
        eml_d0 = ((real_T)(17 * (eml_filterCount - 1)) + 4.0) + (eml_c_loop_ub -
        ...
        eml_m_hoistedExpr_sizes[0] = ((int32_T)eml_d0 -
          (int32_T)eml_b_MOCthreshold_dBOP) + 1;
        eml_loop_ub = (int32_T)eml_d0 - (int32_T)eml_b_MOCthreshold_dBOP;
        for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
          eml_j_hoistedExpr_data[eml_b_loop_ub] = eml_b_MOCthreshold_dBOP +
            (real_T)eml_b_loop_ub;
        }
        eml_b_tmp_sizes[0] = 1;
        eml_b_frameBufferL_sizes[0] = 1;
        eml_b_frameBufferL_sizes[1] = eml_m_hoistedExpr_sizes[0];
        eml_b_tmp_sizes[1] = eml_b_frameBufferL_sizes[1];
        eml_loop_ub = eml_m_hoistedExpr_sizes[0] - 1;
        for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
          eml_tmp_data[eml_b_loop_ub] = eml_j_hoistedExpr_data[eml_b_loop_ub];
        }
        eml_c_tmp_sizes[0] = 1;
        eml_b_frameBufferL_sizes[0] = 1;
        eml_b_frameBufferL_sizes[1] = eml_b_tmp_sizes[1];
        eml_c_tmp_sizes[1] = eml_b_frameBufferL_sizes[1];
        eml_loop_ub = eml_b_tmp_sizes[1] - 1;
        for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
          eml_b_tmp_data[eml_b_loop_ub] = (int32_T)eml_tmp_data[eml_b_loop_ub];
        }
        eml_loop_ub = eml_c_tmp_sizes[1] - 1;
        for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
          for(eml_y = 0; eml_y <= 0; eml_y = 1) {
            eml_filterStatesL[eml_b_tmp_data[eml_b_loop_ub] - 1] =
              eml_d_filterCoeffs[eml_b_loop_ub];
          }
        }
        eml_b_MOCthreshold_dBOP = ((real_T)(17 * (eml_filterCount - 1)) + 3.0) +
          (eml_c_loop_ub - 1.0) * 2.0;
        ...
        eml_n_hoistedExpr_sizes[0] = ((int32_T)eml_d0 -
          (int32_T)eml_b_MOCthreshold_dBOP) + 1;
        eml_loop_ub = (int32_T)eml_d0 - (int32_T)eml_b_MOCthreshold_dBOP;
        for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
        ...
        eml_b_tmp_sizes[0] = 1;
        eml_b_frameBufferL_sizes[0] = 1;
        eml_b_frameBufferL_sizes[1] = eml_n_hoistedExpr_sizes[0];
        eml_b_tmp_sizes[1] = eml_b_frameBufferL_sizes[1];
        eml_loop_ub = eml_n_hoistedExpr_sizes[0] - 1;
        for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
          eml_tmp_data[eml_b_loop_ub] = eml_k_hoistedExpr_data[eml_b_loop_ub];
        }
        eml_loop_ub = 10 * (eml_filterCount - 1);
        eml_y = 10 * (eml_filterCount - 1);
        for(eml_b_loop_ub = 0; eml_b_loop_ub < 2; eml_b_loop_ub++) {
        ...
        eml_o_hoistedExpr_sizes[1] = eml_b_frameBufferL_sizes[1];
        eml_loop_ub = eml_b_frameBufferL_sizes[1] - 1;
        for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
          for(eml_y = 0; eml_y <= 0; eml_y = 1) {
            eml_l_hoistedExpr_data[eml_b_loop_ub] =
              eml_filterStatesR[(int32_T)eml_tmp_data[eml_b_loop_ub] - 1];
          }
        }
        ...
        eml_p_hoistedExpr_sizes[0] = ((int32_T)eml_d0 -
          (int32_T)eml_b_MOCthreshold_dBOP) + 1;
        eml_loop_ub = (int32_T)eml_d0 - (int32_T)eml_b_MOCthreshold_dBOP;
        for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
        ...
        eml_b_tmp_sizes[0] = 1;
        eml_b_frameBufferL_sizes[0] = 1;
        eml_b_frameBufferL_sizes[1] = eml_p_hoistedExpr_sizes[0];
        eml_b_tmp_sizes[1] = eml_b_frameBufferL_sizes[1];
        eml_loop_ub = eml_p_hoistedExpr_sizes[0] - 1;
        for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
          eml_tmp_data[eml_b_loop_ub] = eml_m_hoistedExpr_data[eml_b_loop_ub];
        }
        eml_c_tmp_sizes[0] = 1;
        eml_b_frameBufferL_sizes[0] = 1;
        eml_b_frameBufferL_sizes[1] = eml_b_tmp_sizes[1];
        ...
        for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
          for(eml_y = 0; eml_y <= 0; eml_y = 1) {
            eml_filterStatesR[eml_b_tmp_data[eml_b_loop_ub] - 1] =
              eml_d_filterCoeffs[eml_b_loop_ub];
          }
        }
      }
      ...
      for(eml_nn = 1.0; eml_nn <= eml_c_loop_ub; eml_nn++) {
        ...
        eml_d_tmp_sizes[0] = 1;
        eml_b_frameBufferL_sizes[0] = 1;
        eml_b_frameBufferL_sizes[1] = eml_q_hoistedExpr_sizes[0];
        eml_d_tmp_sizes[1] = eml_b_frameBufferL_sizes[1];
        ...
        for(eml_b_loop_ub = 0; eml_b_loop_ub < 5; eml_b_loop_ub++) {
          eml_e_filterCoeffs[eml_b_loop_ub] = eml_filterCoeffs[(eml_loop_ub + (9
            + eml_b_loop_ub)) - 1];
          eml_f_filterCoeffs[eml_b_loop_ub] = eml_filterCoeffs[(eml_y + (14 +
            eml_b_loop_ub)) - 1];
        }
        eml_b_frameBufferL_sizes[0] = 1;
        eml_b_frameBufferL_sizes[1] = eml_d_tmp_sizes[1];
        eml_r_hoistedExpr_sizes[0] = 1;
        eml_r_hoistedExpr_sizes[1] = eml_b_frameBufferL_sizes[1];
        eml_loop_ub = eml_b_frameBufferL_sizes[1] - 1;
        for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
          for(eml_y = 0; eml_y <= 0; eml_y = 1) {
        ...
        m_b_filter(eml_e_filterCoeffs, eml_f_filterCoeffs, eml_b_yL_data,
         eml_c_yL_sizes, eml_b_filterStatesL_data,
        ...
        eml_s_hoistedExpr_sizes[0] = ((int32_T)eml_d0 -
          (int32_T)eml_b_MOCthreshold_dBOP) + 1;
        eml_loop_ub = (int32_T)eml_d0 - (int32_T)eml_b_MOCthreshold_dBOP;
        for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
        ...
        eml_d_tmp_sizes[0] = 1;
        eml_b_frameBufferL_sizes[0] = 1;
        eml_b_frameBufferL_sizes[1] = eml_s_hoistedExpr_sizes[0];
        eml_d_tmp_sizes[1] = eml_b_frameBufferL_sizes[1];
        ...
        eml_b_frameBufferL_sizes[0] = 1;
        eml_b_frameBufferL_sizes[1] = eml_d_tmp_sizes[1];
        eml_e_tmp_sizes[1] = eml_b_frameBufferL_sizes[1];
        ...
        eml_d_tmp_sizes[0] = 1;
        eml_b_frameBufferL_sizes[0] = 1;
        eml_b_frameBufferL_sizes[1] = eml_t_hoistedExpr_sizes[0];
        eml_d_tmp_sizes[1] = eml_b_frameBufferL_sizes[1];
        ...
        for(eml_y = 0; eml_y < 5; eml_y++) {
          eml_e_filterCoeffs[eml_y] = eml_filterCoeffs[(eml_loop_ub + (9 +
            eml_y)) - 1];
          eml_f_filterCoeffs[eml_y] = eml_filterCoeffs[(eml_b_loop_ub + (14 +
            eml_y)) - 1];
        }
        eml_b_frameBufferL_sizes[0] = 1;
        eml_b_frameBufferL_sizes[1] = eml_d_tmp_sizes[1];
        eml_u_hoistedExpr_sizes[0] = 1;
        eml_u_hoistedExpr_sizes[1] = eml_b_frameBufferL_sizes[1];
        eml_loop_ub = eml_b_frameBufferL_sizes[1] - 1;
        for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
          for(eml_y = 0; eml_y <= 0; eml_y = 1) {
        ...
        eml_v_hoistedExpr_sizes[0] = ((int32_T)eml_d0 -
          (int32_T)eml_b_MOCthreshold_dBOP) + 1;
        eml_loop_ub = (int32_T)eml_d0 - (int32_T)eml_b_MOCthreshold_dBOP;
        for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
        ...
        eml_d_tmp_sizes[0] = 1;
        eml_b_frameBufferL_sizes[0] = 1;
        eml_b_frameBufferL_sizes[1] = eml_v_hoistedExpr_sizes[0];
        eml_d_tmp_sizes[1] = eml_b_frameBufferL_sizes[1];
        eml_loop_ub = eml_v_hoistedExpr_sizes[0] - 1;
        for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
          eml_c_tmp_data[eml_b_loop_ub] = eml_s_hoistedExpr_data[eml_b_loop_ub];
        }
        eml_e_tmp_sizes[0] = 1;
        eml_b_frameBufferL_sizes[0] = 1;
        eml_b_frameBufferL_sizes[1] = eml_d_tmp_sizes[1];
    ...
    m_abs(eml_c_yL_data, eml_yL_sizes, eml_b_hoistedExpr_data,
    ...
    eml_rmsIPL[eml_filterCount - 1] = 20.0 *
      log10(fabs(eml_c_yL_data[eml_yL_sizes[1] - 1]) / 0.00002);
    ...
    eml_loop_ub--;
    for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
      eml_c_yL_data[eml_b_loop_ub] *= eml_b_yR_data[eml_b_loop_ub];
    }
    eml_yR_sizes[0] = 1;
    eml_loop_ub = eml_yR_sizes[1];
    eml_loop_ub--;
    for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
      eml_yR_data[eml_b_loop_ub] *= eml_b_yR_data[eml_b_loop_ub];
    }
    /*  Instantaneous after */
    m_refp1_DRNL_brokenstick_nl(eml_c_yL_data, eml_yL_sizes,
    ...
    if(eml_useGTF) {
      for(eml_c_loop_ub = 1.0; eml_c_loop_ub <= eml_filterOrder;
       eml_c_loop_ub++) {
        ...
        eml_f_tmp_sizes[0] = 1;
        eml_b_frameBufferL_sizes[0] = 1;
        eml_b_frameBufferL_sizes[1] = eml_w_hoistedExpr_sizes[0];
        eml_f_tmp_sizes[1] = eml_b_frameBufferL_sizes[1];
        ...
        eml_b_frameBufferL_sizes[0] = 1;
        eml_b_frameBufferL_sizes[1] = eml_f_tmp_sizes[1];
        eml_x_hoistedExpr_sizes[0] = 1;
        eml_x_hoistedExpr_sizes[1] = eml_b_frameBufferL_sizes[1];
        eml_loop_ub = eml_b_frameBufferL_sizes[1] - 1;
        for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
          for(eml_y = 0; eml_y <= 0; eml_y = 1) {
        ...
        m_filter(eml_b_filterCoeffs, eml_c_filterCoeffs, eml_b_yL_data,
         eml_d_yL_sizes, eml_c_filterStatesL_data,
         eml_c_filterStatesL_sizes, eml_c_yL_data, eml_yL_sizes,
         eml_d_filterCoeffs);
        eml_b_MOCthreshold_dBOP = ((real_T)(17 * (eml_filterCount - 1)) + 11.0)
          + (eml_c_loop_ub - 1.0) * 2.0;
        eml_d0 = ((real_T)(17 * (eml_filterCount - 1)) + 12.0) + (eml_c_loop_ub
        ...
        eml_y_hoistedExpr_sizes[0] = ((int32_T)eml_d0 -
          (int32_T)eml_b_MOCthreshold_dBOP) + 1;
        eml_loop_ub = (int32_T)eml_d0 - (int32_T)eml_b_MOCthreshold_dBOP;
        for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
        ...
        eml_f_tmp_sizes[0] = 1;
        eml_b_frameBufferL_sizes[0] = 1;
        eml_b_frameBufferL_sizes[1] = eml_y_hoistedExpr_sizes[0];
        eml_f_tmp_sizes[1] = eml_b_frameBufferL_sizes[1];
        ...
        eml_b_frameBufferL_sizes[0] = 1;
        eml_b_frameBufferL_sizes[1] = eml_f_tmp_sizes[1];
        eml_g_tmp_sizes[1] = eml_b_frameBufferL_sizes[1];
        ...
        eml_f_tmp_sizes[0] = 1;
        eml_b_frameBufferL_sizes[0] = 1;
        eml_b_frameBufferL_sizes[1] = eml_ab_hoistedExpr_sizes[0];
        eml_f_tmp_sizes[1] = eml_b_frameBufferL_sizes[1];
        ...
        eml_bb_hoistedExpr_sizes[1] = eml_b_frameBufferL_sizes[1];
        eml_loop_ub = eml_b_frameBufferL_sizes[1] - 1;
        for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
          for(eml_y = 0; eml_y <= 0; eml_y = 1) {
        ...
        m_filter(eml_b_filterCoeffs, eml_c_filterCoeffs, eml_b_yL_data,
         ...
         eml_c_filterStatesR_sizes, eml_yR_data, eml_yR_sizes,
         eml_d_filterCoeffs);
        eml_b_MOCthreshold_dBOP = ((real_T)(17 * (eml_filterCount - 1)) + 11.0)
          + (eml_c_loop_ub - 1.0) * 2.0;
        eml_d0 = ((real_T)(17 * (eml_filterCount - 1)) + 12.0) + (eml_c_loop_ub
        ...
        eml_cb_hoistedExpr_sizes[0] = ((int32_T)eml_d0 -
          (int32_T)eml_b_MOCthreshold_dBOP) + 1;
        eml_loop_ub = (int32_T)eml_d0 - (int32_T)eml_b_MOCthreshold_dBOP;
        for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
        ...
        eml_f_tmp_sizes[0] = 1;
        eml_b_frameBufferL_sizes[0] = 1;
        eml_b_frameBufferL_sizes[1] = eml_cb_hoistedExpr_sizes[0];
        eml_f_tmp_sizes[1] = eml_b_frameBufferL_sizes[1];
        eml_loop_ub = eml_cb_hoistedExpr_sizes[0] - 1;
        for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
          eml_e_tmp_data[eml_b_loop_ub] = eml_y_hoistedExpr_data[eml_b_loop_ub];
        }
        eml_g_tmp_sizes[0] = 1;
        eml_b_frameBufferL_sizes[0] = 1;
        eml_b_frameBufferL_sizes[1] = eml_f_tmp_sizes[1];
      ...
      for(eml_nn = 1.0; eml_nn <= eml_c_loop_ub; eml_nn++) {
        ...
        eml_loop_ub -= eml_y;
        for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
          eml_ab_hoistedExpr_data[eml_b_loop_ub] = (real_T)eml_y +
            (real_T)eml_b_loop_ub;
        }
        eml_h_tmp_sizes[0] = 1;
        eml_b_frameBufferL_sizes[0] = 1;
        eml_b_frameBufferL_sizes[1] = eml_db_hoistedExpr_sizes[0];
        eml_h_tmp_sizes[1] = eml_b_frameBufferL_sizes[1];
        ...
        eml_b_frameBufferL_sizes[0] = 1;
        eml_b_frameBufferL_sizes[1] = eml_h_tmp_sizes[1];
        eml_eb_hoistedExpr_sizes[0] = 1;
        eml_eb_hoistedExpr_sizes[1] = eml_b_frameBufferL_sizes[1];
        eml_loop_ub = eml_b_frameBufferL_sizes[1] - 1;
        for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
          for(eml_y = 0; eml_y <= 0; eml_y = 1) {
        ...
        m_b_filter(eml_e_filterCoeffs, eml_f_filterCoeffs, eml_b_yL_data,
         eml_e_yL_sizes, eml_d_filterStatesL_data,
        ...
        eml_loop_ub -= eml_y;
        for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
          eml_cb_hoistedExpr_data[eml_b_loop_ub] = (real_T)eml_y +
            (real_T)eml_b_loop_ub;
        }
        eml_h_tmp_sizes[0] = 1;
        eml_b_frameBufferL_sizes[0] = 1;
        eml_b_frameBufferL_sizes[1] = eml_fb_hoistedExpr_sizes[0];
        eml_h_tmp_sizes[1] = eml_b_frameBufferL_sizes[1];
        ...
        eml_b_frameBufferL_sizes[0] = 1;
        eml_b_frameBufferL_sizes[1] = eml_h_tmp_sizes[1];
        eml_i_tmp_sizes[1] = eml_b_frameBufferL_sizes[1];
        ...
        eml_loop_ub -= eml_y;
        for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
          eml_db_hoistedExpr_data[eml_b_loop_ub] = (real_T)eml_y +
            (real_T)eml_b_loop_ub;
        }
        eml_h_tmp_sizes[0] = 1;
        eml_b_frameBufferL_sizes[0] = 1;
        eml_b_frameBufferL_sizes[1] = eml_gb_hoistedExpr_sizes[0];
        eml_h_tmp_sizes[1] = eml_b_frameBufferL_sizes[1];
        ...
        eml_hb_hoistedExpr_sizes[1] = eml_b_frameBufferL_sizes[1];
        eml_loop_ub = eml_b_frameBufferL_sizes[1] - 1;
        for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
          for(eml_y = 0; eml_y <= 0; eml_y = 1) {
        ...
        eml_loop_ub -= eml_y;
        for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
          eml_fb_hoistedExpr_data[eml_b_loop_ub] = (real_T)eml_y +
            (real_T)eml_b_loop_ub;
        }
        eml_h_tmp_sizes[0] = 1;
        eml_b_frameBufferL_sizes[0] = 1;
        eml_b_frameBufferL_sizes[1] = eml_ib_hoistedExpr_sizes[0];
        eml_h_tmp_sizes[1] = eml_b_frameBufferL_sizes[1];
        eml_loop_ub = eml_ib_hoistedExpr_sizes[0] - 1;
        for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
          eml_g_tmp_data[eml_b_loop_ub] = eml_fb_hoistedExpr_data[eml_b_loop_ub];
        }
        eml_i_tmp_sizes[0] = 1;
        eml_b_frameBufferL_sizes[0] = 1;
        eml_b_frameBufferL_sizes[1] = eml_h_tmp_sizes[1];
    ...
    /* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
    m_abs(eml_c_yL_data, eml_yL_sizes, eml_yL_data, eml_f_yL_sizes);
    eml_loop_ub = eml_f_yL_sizes[1] - 1;
    for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
      eml_y = eml_f_yL_sizes[0] - 1;
      for(eml_i4 = 0; eml_i4 <= eml_y; eml_i4++) {
        eml_yL_data[eml_i4 + eml_f_yL_sizes[0] * eml_b_loop_ub] +=
    ...
    m_refp1_log10(eml_yL_data, eml_f_yL_sizes);
    eml_f_yL_sizes[0] = 1;
    eml_loop_ub = eml_f_yL_sizes[1] - 1;
    for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
    ...
    m_abs(eml_yR_data, eml_yR_sizes, eml_A_data, eml_frameBufferL_sizes);
    eml_loop_ub = eml_frameBufferL_sizes[1] - 1;
    for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
      eml_y = eml_frameBufferL_sizes[0] - 1;
      for(eml_i4 = 0; eml_i4 <= eml_y; eml_i4++) {
    ...
    /* dB peak level with 16 bit offset */
    eml_g_yL_sizes[0] = 2;
    eml_g_yL_sizes[1] = eml_f_yL_sizes[1];
    eml_loop_ub = eml_f_yL_sizes[1] - 1;
    for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
    ...
    m_sum(eml_d_yL_data, eml_g_yL_sizes, eml_b_hoistedExpr_data,
     eml_b_hoistedExpr_sizes);
    for(eml_loop_ub = 0; eml_loop_ub < 2; eml_loop_ub++) {
    ...
    m_c_filter(eml_b_filterCoeffs, eml_d_filterCoeffs, eml_b_yL_data,
     eml_jb_hoistedExpr_sizes, eml_filterStatesL[17 * (
    ...
    m_b_max(eml_b_yL_data, eml_kb_hoistedExpr_sizes, eml_b_hoistedExpr_data,
     eml_b_hoistedExpr_sizes);
    eml_b_hoistedExpr_sizes[0] = 1;
    ...
    eml_lb_hoistedExpr_sizes[0] = eml_loop_ub;
    eml_loop_ub--;
    for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
      eml_gb_hoistedExpr_data[eml_b_loop_ub] = 1.0 + (real_T)eml_b_loop_ub;
    }
    eml_loop_ub = eml_lb_hoistedExpr_sizes[0] - 1;
    for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
      eml_b_yR_data[eml_b_loop_ub] = eml_gb_hoistedExpr_data[eml_b_loop_ub];
    }
    eml_mb_hoistedExpr_sizes[0] = 1;
    eml_mb_hoistedExpr_sizes[1] = eml_b_hoistedExpr_sizes[1];
    eml_loop_ub = eml_b_hoistedExpr_sizes[1] - 1;
    for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
      eml_f_hoistedExpr_data[eml_b_loop_ub] =
        eml_b_hoistedExpr_data[eml_b_loop_ub] / 20.0;
    }
    m_b_power(eml_f_hoistedExpr_data, eml_mb_hoistedExpr_sizes, eml_b_yL_data,
     eml_tmp_sizes);
    eml_loop_ub = eml_filterCount - 1;
    eml_b_loop_ub = eml_tmp_sizes[1] - 1;
    for(eml_y = 0; eml_y <= eml_b_loop_ub; eml_y++) {
      eml_MOCcontrol[eml_loop_ub + 11 * ((int32_T)eml_b_yR_data[eml_y] - 1)] =
        eml_b_yL_data[eml_tmp_sizes[0] * eml_y];
    }
    ...
    eml_rmsOPL[eml_filterCount - 1] = eml_yL_data[eml_f_yL_sizes[1] - 1];
    ...
    eml_b_hoistedExpr_sizes[0] = 1;
    eml_tmp_sizes[0] = 1;
    eml_tmp_sizes[1] = eml_nb_hoistedExpr_sizes[0];
    eml_b_hoistedExpr_sizes[1] = eml_tmp_sizes[1];
    ...
    for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
      eml_b_yR_data[eml_b_loop_ub] = eml_ib_hoistedExpr_data[eml_b_loop_ub];
    }
    eml_tmp_sizes[0] = 1;
    eml_tmp_sizes[1] = eml_b_hoistedExpr_sizes[1];
    ...
    for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
      for(eml_y = 0; eml_y <= 0; eml_y = 1) {
        eml_b_yL_data[eml_b_loop_ub] =
          eml_frameBufferL[(int32_T)eml_b_hoistedExpr_data[eml_b_loop_ub] - 1] +
          eml_c_yL_data[
          eml_yL_sizes[0] * eml_b_loop_ub] * eml_b_MOCthreshold_dBOP;
      }
    }
    eml_loop_ub = eml_c_frameBufferL_sizes[1] - 1;
    for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
      eml_frameBufferL[(int32_T)eml_b_yR_data[eml_b_loop_ub] - 1] =
        eml_b_yL_data[eml_b_loop_ub];
    }
    ...
    eml_b_hoistedExpr_sizes[0] = 1;
    eml_tmp_sizes[0] = 1;
    eml_tmp_sizes[1] = eml_pb_hoistedExpr_sizes[0];
    eml_b_hoistedExpr_sizes[1] = eml_tmp_sizes[1];
    eml_loop_ub = eml_pb_hoistedExpr_sizes[0] - 1;
    for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
      eml_b_hoistedExpr_data[eml_b_loop_ub] =
        eml_jb_hoistedExpr_data[eml_b_loop_ub];
    }
    eml_b_MOCthreshold_dBOP = eml_mainGain[eml_filterCount - 1];
    ...
    for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
      eml_b_yR_data[eml_b_loop_ub] = eml_kb_hoistedExpr_data[eml_b_loop_ub];
    }
    eml_tmp_sizes[0] = 1;
    eml_tmp_sizes[1] = eml_b_hoistedExpr_sizes[1];
    ...
    for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
      eml_frameBufferR[(int32_T)eml_b_yR_data[eml_b_loop_ub] - 1] =
        eml_b_yL_data[eml_b_loop_ub];
    }
  }
  /*  BF channel */
  ...
  eml_b_hoistedExpr_sizes[0] = 1;
  eml_b_frameBufferL_sizes[0] = 1;
  eml_b_frameBufferL_sizes[1] = eml_rb_hoistedExpr_sizes[0];
  eml_b_hoistedExpr_sizes[1] = eml_b_frameBufferL_sizes[1];
  eml_loop_ub = eml_rb_hoistedExpr_sizes[0] - 1;
  for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
    eml_b_hoistedExpr_data[eml_b_loop_ub] =
      eml_lb_hoistedExpr_data[eml_b_loop_ub];
  }
  eml_b_frameBufferL_sizes[0] = 1;
  eml_b_frameBufferL_sizes[1] = eml_b_hoistedExpr_sizes[1];
  eml_d_frameBufferL_sizes[0] = 1;
  eml_d_frameBufferL_sizes[1] = eml_b_frameBufferL_sizes[1];
  eml_loop_ub = eml_b_frameBufferL_sizes[1] - 1;
  for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
    for(eml_y = 0; eml_y <= 0; eml_y = 1) {
      eml_frameBufferL_data[eml_b_loop_ub] =
        eml_frameBufferL[(int32_T)eml_b_hoistedExpr_data[eml_b_loop_ub] - 1];
    }
  }
  m_c_power(eml_frameBufferL_data, eml_d_frameBufferL_sizes,
  ...
  m_c_filter(eml_b_filterCoeffs, eml_d_filterCoeffs, eml_b_hoistedExpr_data,
   eml_b_hoistedExpr_sizes, eml_filterStatesL[0],
   eml_yL_data, eml_f_yL_sizes, &eml_b_MOCthreshold_dBOP);
  ...
  eml_b_hoistedExpr_sizes[0] = 1;
  eml_b_frameBufferL_sizes[0] = 1;
  eml_b_frameBufferL_sizes[1] = eml_sb_hoistedExpr_sizes[0];
  eml_b_hoistedExpr_sizes[1] = eml_b_frameBufferL_sizes[1];
  ...
  eml_b_frameBufferL_sizes[0] = 1;
  eml_b_frameBufferL_sizes[1] = eml_b_hoistedExpr_sizes[1];
  eml_b_frameBufferR_sizes[0] = 1;
  eml_b_frameBufferR_sizes[1] = eml_b_frameBufferL_sizes[1];
  eml_loop_ub = eml_b_frameBufferL_sizes[1] - 1;
  for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
    for(eml_y = 0; eml_y <= 0; eml_y = 1) {
      eml_frameBufferR_data[eml_b_loop_ub] =
        eml_frameBufferR[(int32_T)eml_b_hoistedExpr_data[eml_b_loop_ub] - 1];
    }
  }
  m_c_power(eml_frameBufferR_data, eml_b_frameBufferR_sizes,
   eml_b_hoistedExpr_data, eml_b_hoistedExpr_sizes);
  for(eml_loop_ub = 0; eml_loop_ub < 2; eml_loop_ub++) {
    eml_b_filterCoeffs[eml_loop_ub] = eml_filterCoeffs[eml_loop_ub];
    eml_d_filterCoeffs[eml_loop_ub] = eml_filterCoeffs[eml_loop_ub + 2];
  ...
  m_c_filter(eml_b_filterCoeffs, eml_d_filterCoeffs, eml_b_hoistedExpr_data,
   ...
   eml_b_yR_data, eml_frameBufferL_sizes, &eml_b_MOCthreshold_dBOP);
  eml_filterStatesR[0] = eml_b_MOCthreshold_dBOP;
  /*  restore Pa scale */
  m_refp1_sqrt(eml_yL_data, eml_f_yL_sizes);
  /* confusing name for parameter - it is a short term RMS. */
  m_refp1_sqrt(eml_b_yR_data, eml_frameBufferL_sizes);
  /* confusing name for parameter - it is a short term RMS. */
  /*  % % % attenuate input (NB cross product used) */
  ...
  eml_b_hoistedExpr_sizes[0] = 1;
  eml_b_frameBufferL_sizes[0] = 1;
  eml_b_frameBufferL_sizes[1] = eml_tb_hoistedExpr_sizes[0];
  eml_b_hoistedExpr_sizes[1] = eml_b_frameBufferL_sizes[1];
  eml_loop_ub = eml_tb_hoistedExpr_sizes[0] - 1;
  for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
    eml_b_hoistedExpr_data[eml_b_loop_ub] =
      eml_nb_hoistedExpr_data[eml_b_loop_ub];
  }
  eml_loop_ub = eml_f_yL_sizes[1] - 1;
  for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
    eml_ARampL[(int32_T)eml_b_hoistedExpr_data[eml_b_loop_ub] - 1] =
      eml_yL_data[eml_f_yL_sizes[0] * eml_b_loop_ub] /
      eml_ARthresholdPa;
  }
  if(1.0 > eml_numSamples) {
    eml_loop_ub = 0;
  ...
  eml_b_hoistedExpr_sizes[0] = 1;
  eml_b_frameBufferL_sizes[0] = 1;
  eml_b_frameBufferL_sizes[1] = eml_ub_hoistedExpr_sizes[0];
  eml_b_hoistedExpr_sizes[1] = eml_b_frameBufferL_sizes[1];
  ...
  for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
    eml_ARampR[(int32_T)eml_b_hoistedExpr_data[eml_b_loop_ub] - 1] =
      eml_b_yR_data[eml_frameBufferL_sizes[0] * eml_b_loop_ub] /
      eml_ARthresholdPa;
  }
  /*  all sub-treshold values are set to 1 */
  if(1.0 > eml_numSamples) {
  ...
  eml_b_hoistedExpr_sizes[0] = 1;
  eml_b_frameBufferL_sizes[0] = 1;
  eml_b_frameBufferL_sizes[1] = eml_vb_hoistedExpr_sizes[0];
  eml_b_hoistedExpr_sizes[1] = eml_b_frameBufferL_sizes[1];
  eml_loop_ub = eml_vb_hoistedExpr_sizes[0] - 1;
  for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
    eml_b_hoistedExpr_data[eml_b_loop_ub] =
      eml_pb_hoistedExpr_data[eml_b_loop_ub];
  }
  eml_b_frameBufferL_sizes[0] = 1;
  eml_b_frameBufferL_sizes[1] = eml_b_hoistedExpr_sizes[1];
  eml_frameBufferL_sizes[0] = 1;
  eml_frameBufferL_sizes[1] = eml_b_frameBufferL_sizes[1];
  eml_loop_ub = eml_b_frameBufferL_sizes[1] - 1;
  for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
    for(eml_y = 0; eml_y <= 0; eml_y = 1) {
  ...
  eml_f_yR_sizes[0] = 1;
  eml_f_yR_sizes[1] = eml_frameBufferL_sizes[1];
  eml_loop_ub = eml_frameBufferL_sizes[1] - 1;
  for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
    eml_c_yR_data[eml_b_loop_ub] = (eml_b_yR_data[eml_b_loop_ub] < 1.0);
  }
  m_eml_li_find(eml_c_yR_data, eml_f_yR_sizes, eml_i_tmp_data, eml_tmp_sizes);
  eml_j_tmp_sizes[0] = 1;
  eml_b_frameBufferL_sizes[0] = 1;
  eml_b_frameBufferL_sizes[1] = eml_tmp_sizes[1];
  eml_j_tmp_sizes[1] = eml_b_frameBufferL_sizes[1];
  eml_loop_ub = eml_tmp_sizes[1] - 1;
  for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
    eml_j_tmp_data[eml_b_loop_ub] = eml_i_tmp_data[eml_b_loop_ub];
  }
  eml_loop_ub = eml_j_tmp_sizes[1] - 1;
  for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
    for(eml_y = 0; eml_y <= 0; eml_y = 1) {
      eml_ARampL[eml_j_tmp_data[eml_b_loop_ub] - 1] = 1.0;
    }
  }
  if(1.0 > eml_numSamples) {
    eml_loop_ub = 0;
  ...
  eml_b_hoistedExpr_sizes[0] = 1;
  eml_b_frameBufferL_sizes[0] = 1;
  eml_b_frameBufferL_sizes[1] = eml_wb_hoistedExpr_sizes[0];
  eml_b_hoistedExpr_sizes[1] = eml_b_frameBufferL_sizes[1];
  eml_loop_ub = eml_wb_hoistedExpr_sizes[0] - 1;
  for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
    eml_b_hoistedExpr_data[eml_b_loop_ub] =
      eml_qb_hoistedExpr_data[eml_b_loop_ub];
  }
  eml_b_frameBufferL_sizes[0] = 1;
  eml_b_frameBufferL_sizes[1] = eml_b_hoistedExpr_sizes[1];
  eml_frameBufferL_sizes[0] = 1;
  ...
  eml_g_yR_sizes[0] = 1;
  eml_g_yR_sizes[1] = eml_frameBufferL_sizes[1];
  eml_loop_ub = eml_frameBufferL_sizes[1] - 1;
  for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
    eml_c_yR_data[eml_b_loop_ub] = (eml_b_yR_data[eml_b_loop_ub] < 1.0);
  }
  m_eml_li_find(eml_c_yR_data, eml_g_yR_sizes, eml_i_tmp_data, eml_tmp_sizes);
  eml_j_tmp_sizes[0] = 1;
  eml_b_frameBufferL_sizes[0] = 1;
  eml_b_frameBufferL_sizes[1] = eml_tmp_sizes[1];
  eml_j_tmp_sizes[1] = eml_b_frameBufferL_sizes[1];
  ...
  for(eml_b_loop_ub = 0; eml_b_loop_ub <= eml_loop_ub; eml_b_loop_ub++) {
    for(eml_y = 0; eml_y <= 0; eml_y = 1) {
      eml_ARampR[eml_j_tmp_data[eml_b_loop_ub] - 1] = 1.0;
    }
  }
}
