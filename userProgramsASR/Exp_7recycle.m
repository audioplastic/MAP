...
for nn = 0*recConditions+1:1*recConditions    
    ...
    xR{nn}.MAPparamChanges= {'DRNLParams.a=10000;', 'DRNLParams.rateToAttenuationFactorProb = -0.08;', 'DRNLParams.MOCrateThresholdProb =57;', 'DRNLParams.MOCtau =0.35;'};
...
for nn = 1*recConditions+1:2*recConditions    
    ...
    xR{nn}.numWavs = testWavs; %MAX = 358
    xR{nn}.noiseLevToUse = nzLevel(tmpIdx);
    xR{nn}.MAPparamChanges= {'DRNLParams.a=10000;', 'DRNLParams.rateToAttenuationFactorProb = 0;', 'DRNLParams.MOCrateThresholdProb =57;', 'DRNLParams.MOCtau =0.35;'};
