function [frequencies fft_ampdB]= testDPOAE (leveldBSPL, toneFrequencies)
...
%
% Input arguments:
%  leveldBSPL (all frequencies equal level; default = 70 dB SPL)
%  toneFrequencies: defaults are [5000 6000]
%
% e.g. 
...
plot(time,OAE)
title(['OAE:   F=' num2str(toneFrequencies)])
