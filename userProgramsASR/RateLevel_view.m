...
paramChanges = {};
paramChanges{numel(paramChanges)+1} = 'DRNLParams.rateToAttenuationFactorProb =  0.0;';%GOOD = 0.012  %DEFAULT = 0.005;  % strength of MOC
...
paramChanges{numel(paramChanges)+1} = 'DRNLParams.a = 625;';
