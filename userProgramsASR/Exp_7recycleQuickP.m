...
xL.MAPparamChanges= {' DRNLParams.rateToAttenuationFactorProb = 0;', 'OMEParams.rateToAttenuationFactorProb=0;', 'DRNLParams.MOCtau = 0.3;' };
...
for nn = 0*recConditions+1:1*recConditions    
    ...
    xR{nn}.MAPparamChanges= {'DRNLParams.rateToAttenuationFactorProb = 5; DRNLParams.MOCrateThresholdProb = 100;'};
...
for nn = 1*recConditions+1:2*recConditions    
    ...
    xR{nn}.numWavs = testWavs; %MAX = 358
    xR{nn}.noiseLevToUse = nzLevel(tmpIdx);
    xR{nn}.MAPparamChanges= {'DRNLParams.rateToAttenuationFactorProb = 6; DRNLParams.MOCrateThresholdProb = 100;'};
...
for nn = 2*recConditions+1:3*recConditions    
    ...
    xR{nn}.numWavs = testWavs; %MAX = 358
    xR{nn}.noiseLevToUse = nzLevel(tmpIdx);
    xR{nn}.MAPparamChanges= {'DRNLParams.rateToAttenuationFactorProb = 7; DRNLParams.MOCrateThresholdProb = 100;'};
...
for nn = 3*recConditions+1:4*recConditions    
    ...
    xR{nn}.numWavs = testWavs; %MAX = 358
    xR{nn}.noiseLevToUse = nzLevel(tmpIdx);
    xR{nn}.MAPparamChanges= {'DRNLParams.rateToAttenuationFactorProb = 8; DRNLParams.MOCrateThresholdProb = 100;'};
...
for nn = 4*recConditions+1:5*recConditions    
    ...
    xR{nn}.numWavs = testWavs; %MAX = 358
    xR{nn}.noiseLevToUse = nzLevel(tmpIdx);
    xR{nn}.MAPparamChanges= {'DRNLParams.rateToAttenuationFactorProb = 5; DRNLParams.MOCrateThresholdProb = 85;'};
...
for nn = 5*recConditions+1:6*recConditions    
    ...
    xR{nn}.numWavs = testWavs; %MAX = 358
    xR{nn}.noiseLevToUse = nzLevel(tmpIdx);
    xR{nn}.MAPparamChanges= {'DRNLParams.rateToAttenuationFactorProb = 6; DRNLParams.MOCrateThresholdProb = 85;'};
...
for nn = 6*recConditions+1:7*recConditions    
    ...
    xR{nn}.numWavs = testWavs; %MAX = 358
    xR{nn}.noiseLevToUse = nzLevel(tmpIdx);
    xR{nn}.MAPparamChanges= {'DRNLParams.rateToAttenuationFactorProb = 7; DRNLParams.MOCrateThresholdProb = 85;'};
...
for nn = 7*recConditions+1:8*recConditions    
    ...
    xR{nn}.numWavs = testWavs; %MAX = 358
    xR{nn}.noiseLevToUse = nzLevel(tmpIdx);
    xR{nn}.MAPparamChanges= {'DRNLParams.rateToAttenuationFactorProb = 8; DRNLParams.MOCrateThresholdProb = 85;'};
...
if ~isMasterNode %dont bother wasting master node effort on generating testing features (for now)
    for nn = 0*recConditions+1:8*recConditions
