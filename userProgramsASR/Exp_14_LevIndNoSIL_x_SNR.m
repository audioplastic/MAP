function Exp_14_LevIndNoSIL_x_SNR(isMasterNode, SNR)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
expName = ['14LevWithSIL_' num2str(SNR) '_SNR'];
if isunix
...
nzLevel = [-200 40 45 50 55 60 65 70];
...
xL.noiseOffOneInX = 0; %change before copy
