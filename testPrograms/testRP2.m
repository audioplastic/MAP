...
% testIHC evaluates DRNL & IHC I/O function for comparing with three specific
%   sets of animal data.
% e.g. testRP2('Normal','');

global  method inputStimulusParams
global  DRNLoutput IHC_cilia_output IHCoutput
