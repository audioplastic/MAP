...
%                 'OMEParams.ARtau=0.1;',...
%                 'DRNLParams.MOCtauR=0.800;',...
%                 'DRNLParams.MOCtauF=0.150;',...%DRNLParams.MOCtauR;',...                
...
global dt dtSpikes saveAN_spikesOrProbability savedBFlist saveMAPparamsName...
...
if strcmpi (xL.MAPspikesOrProb, 'probability')
...
figure(99)
% dt=ANdt
startP = round(xL.truncateDur*(1/dt)); %We use dt, and not dtSpikes, because th
