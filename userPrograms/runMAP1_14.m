...
%   or
% C. signal is taken from a .wav file in wavFileStore
signalType= 'file';
...
%   or 
% specify your own channel BFs, for example
% numChannels=1;
...
switch signalType
    case 'tones'
        ...
        showMapOptions.fileName='tones'; % no file name for display
    ...
    case 'file'
        ...
        inputSignal= [intialSilence inputSignal' finalSilence];
        showMapOptions.fileName=fileName; % for showMap display
end
