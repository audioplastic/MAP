...
% - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
% These globals will find results from MAP1_14
...
%   or
% B. file input (comment out ifunused)
signalType= 'file';
fileName='Oh No';
...
waveHeight=.3;
UTIL_cascadePlot(SACF(:,idx)', 1000./pitches, waveHeight)

xlabel('lag (ms)'), ylabel('time pointer -->')
